...
def image_download(keyword):
    ...
    try:
        driver.find_element_by_xpath(
            '//*[@id="islmp"]/html/body/ntp-app//div/div[1]/ntp-realbox//div/input').click()
    ...
    for i in range(1, len(images)):
        try:
            print('//*[@id="islmp"]/html/body/ntp-app//div/div[1]/ntp-realbox//div/input/img')
...
if __name__ == '__main__':
    pool = Pool(processes=1)  # 5개의 프로세스를 사용합니다.
