...
for i in all_labels:
    globals()["img_"+i+"_path"] = f"./data/{i}"
    globals()["img_"+i] = glob.glob(os.path.join(globals()["img_"+i+"_path"], "*.jpg"))

for i in all_labels:
    globals()["img_"+i+"_path"] = f"./data/{i}"
    globals()["img_"+i] = glob.glob(os.path.join(globals()["img_"+i+"_path"], "*.jpeg"))


'''
각 라벨별로 생성됨 >
img_cloudy_path = "./data/cloudy"
img_cloudy = glob.glob(os.path.join(img_cloudy_path, "*.png"))
'''
